...
void main() {
  ...
  test('should call createHabit on the database helper', () async {
    // arrange
  ...
  test('should call getAllHabits on the database helper', () async {
    // arrange
  ...
  test('should call deleteHabit on the database helper', () async {
    // arrange
